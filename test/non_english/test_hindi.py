...
from src.bible_io_references.languages import hindi

LANGUAGE = BibleLanguageEnum.HINDI


@pytest.mark.parametrize(
    "reference, expected",
    [
        ("यूहन्ना 3:16", (BibleBookEnum.John, 3, 16)),
        ("प्रका 21:4", (BibleBookEnum.Revelation, 21, 4)),
    ],
)
