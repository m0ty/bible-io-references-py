...
from src.bible_io_references.languages import german

LANGUAGE = BibleLanguageEnum.GERMAN


@pytest.mark.parametrize(
    "reference, expected",
    [
        ("Johannes 3:16", (BibleBookEnum.John, 3, 16)),
        ("Offb 21:4", (BibleBookEnum.Revelation, 21, 4)),
    ],
)
