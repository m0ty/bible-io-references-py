...
BOOK_NAMES: Dict[BibleBookEnum, Iterable[str]] = {
    ...
    BibleBookEnum.Tobit: ('Товит',),
    BibleBookEnum.Judith: ('Иудифь',),
    BibleBookEnum.Wisdom: ('Премудрость Соломона',),
    BibleBookEnum.Sirach: ('Премудрость Иисуса, сына Сирахова',),
    BibleBookEnum.Baruch: ('Варух',),
    BibleBookEnum.FirstMaccabees: ('1 Маккавейская',),
    BibleBookEnum.SecondMaccabees: ('2 Маккавейская',),
    BibleBookEnum.EstherAdditions: ('Есфирь (греческая)',),
    BibleBookEnum.DanielSongOfThree: ('Даниил (Песнь трёх отроков)',),
    BibleBookEnum.DanielSusanna: ('Даниил (Сусанна)',),
    BibleBookEnum.DanielBelAndTheDragon: ('Даниил (Вил и дракон)',),
    BibleBookEnum.FirstEsdras: ('1 Ездры',),
    BibleBookEnum.SecondEsdras: ('2 Ездры',),
    BibleBookEnum.PrayerOfManasseh: ('Молитва Манассии',),
    BibleBookEnum.Psalm151: ('Псалом 151',),
    BibleBookEnum.ThirdMaccabees: ('3 Маккавейская',),
    BibleBookEnum.FourthMaccabees: ('4 Маккавейская',),
}
